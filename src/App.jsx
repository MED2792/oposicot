  ...
  return (
    ...
    >
      <style>{`
        ...
        .osc-display { font-family: 'Space Grotesk', sans-serif; }
        .osc-option {
      ...
      >
        <div>
          <div
            className="osc-mono"
            style={{ fontSize: "11px", letterSpacing: "0.14em", color: "#5C7A88" }}
          >
            OPOSICOT · BANCO DE PREGUNTAS
          </div>
          <div className="osc-display" style={{ fontSize: "20px", fontWeight: 600 }}>
            Informe de sesión — Traumatología
          </div>
        </div>
        {stage === "quiz" && (
