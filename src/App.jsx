...
const QUESTIONS = [
  ...
  },
  {
    ...
    image: null,
    prompt:
      "Varón de 45 años con antecedente de epilepsia sufre una crisis convulsiva. A su llegada a Urgencias presenta dolor bilateral en hombros, con limitación marcada de la rotación externa pasiva en ambos lados y elevación restringida por debajo de 90º. ¿Cuál es la sospecha diagnóstica principal y qué NO se debe hacer al intentar la reducción?",
    options: [
      "Luxación anterior bilateral; se debe reducir mediante rotación externa forzada",
      "Luxación posterior bilateral; nunca se debe realizar rotación externa forzada durante la reducción, ya que puede producir fracturas",
      "Fractura de troquíter bilateral; no requiere maniobra de reducción",
      "Rotura bilateral del manguito rotador; tratamiento conservador exclusivamente",
    ],
    correct: 1,
    explanation:
      "La limitación de la rotación externa pasiva tras una crisis convulsiva es el signo diagnóstico fundamental de luxación posterior de hombro (a menudo bilateral). Para reducirla se emplea rotación interna con tracción; nunca debe forzarse la rotación externa, ya que puede producir fracturas.",
  },
  {
    id: 73,
    block: "ms",
    ...
    options: [
      "Tratamiento conservador siempre en una primera luxación, independientemente del perfil del paciente",
      ...
      "Cirugía solo si aparece una segunda luxación, sin excepciones",
  ...
  },
  {
    ...
    options: [
      ...
      "Está contraindicada cualquier cirugía por debajo del 20% de defecto",
      "Debe realizarse siempre un aloinjerto de tibia distal como primera opción"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Lesión de Perthes invertida; siempre asociada a luxación posterior franca"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Tratamiento conservador exclusivamente, ya que las fracturas de troquíter siempre consolidan bien",
  ...
  },
  {
    ...
    options: [
      "Luxación posterior; descartar lesión del nervio supraescapular exclusivamente",
  ...
  },
  {
    ...
    options: [
      "Tratamiento siempre conservador hasta el cierre fisario, sin excepciones",
  ...
  },
  {
    ...
    options: [
      ...
      "Aplicar frío local y analgesia oral únicamente",
  ...
  },
  {
    ...
    options: [
      "Está indicado únicamente cuando existen múltiples factores de riesgo de recidiva, pero no ante un defecto óseo significativo aislado",
      ...
      "Ha sido completamente abandonado en la práctica actual",
  ...
  },
  {
    ...
    options: [
      ...
      "Prótesis inversa obligatoria en toda fractura desplazada en mayores de 65 años",
  ...
  },
  {
    ...
    options: [
      ...
      "Osteosíntesis con placa LCP en todos los casos, independientemente de la edad",
      "Tratamiento conservador con Velpeau exclusivamente"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Tratamiento conservador exclusivo, contraindicando cualquier cirugía"
    ],
    correct: 1,
    explanation:
      "La prótesis inversa está indicada en el anciano con relativamente alta demanda funcional cuando existe conminución importante de las tuberosidades no susceptible de osteosíntesis, siempre que exista funcionalidad del músculo deltoides; si no la hay, no debe implantarse.",
  },
  {
    id: 87,
    block: "ms",
  ...
  },
  {
    ...
    options: [
      ...
      "Continuar únicamente con fisioterapia sin ninguna otra medida"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "RM bajo sedación, de entrada, en todos los casos",
      "Ninguna prueba es necesaria; el diagnóstico es exclusivamente clínico"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Signo de la charretera; indica luxación glenohumeral asociada obligatoria",
  ...
  },
  {
    ...
    options: [
      "Osteosíntesis con agujas percutáneas, técnica de elección en toda fractura de cuello anatómico",
      ...
      "Tratamiento conservador exclusivamente, sin valorar cirugía en ningún caso",
      "Amputación funcional del miembro"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Amputación funcional del miembro",
      "Tratamiento conservador exclusivo sin ninguna intervención"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Depende exclusivamente de la arteria circunfleja humeral anterior",
      ...
      "Depende exclusivamente de ramas directas de la arteria subclavia"
    ],
    correct: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Tratamiento conservador exclusivamente, dado que las fracturas asociadas ipsilaterales no modifican la indicación",
      ...
      "Amputación funcional del miembro superior",
      "Prótesis inversa obligatoria independientemente de la edad"
    ],
    correct: 1,
    explanation:
